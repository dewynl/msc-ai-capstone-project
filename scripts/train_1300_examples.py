...
def run_1300_training(
    ...
    logger.info("=" * 80)
    logger.info("🚀 TRAINING WITH 1,300 EXAMPLES")
    logger.info("=" * 80)
    ...
    logger.info(f"Expected duration: ~{(146 * num_epochs / 10 * 103 / 3600):.1f} hours")
    logger.info("=" * 80)
    ...
    # Estimate training time (conservative: 110s per step with larger batch)
    estimated_seconds = total_steps * 110
